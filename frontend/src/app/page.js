...
export default function RootPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#070c18] text-white flex flex-col overflow-x-hidden select-none">
      ...
      {/* ── FOOTER ── */}
      <footer className="relative z-10 pt-2 pb-5 desk:py-5 px-3 xxs:px-4 xs:px-5 sm:px-8 desk:px-16 w-full max-w-[1720px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3 text-[11px] xs:text-xs text-slate-400 text-center sm:text-left">
        <div className="leading-relaxed space-y-0.5">
          ...
          <div className="text-[10px] xs:text-[11px] text-slate-500 dark:text-slate-500">
            Developed by Yana Malhotra, Harsh Raj Singh, Sumit Tripathi &amp; Sanchit Aggarwal
          </div>
        </div>
        <div className="flex items-center gap-2 text-slate-400 hover:text-white cursor-pointer transition-colors text-[11px] xs:text-xs">
          <span>Need Help?</span>
